...
async function main() {
  ...
  const [xauusd, nas100, us30, btcusdt, ethusdt] = await db
    ...
    .values([
      ...
      { symbol: "BTCUSDT", name: "Bitcoin / Tether", assetClass: "Crypto", settlementCurrency: "USDT", quantityUnit: "contracts", contractMultiplier: "0.001", isActive: true },
      { symbol: "ETHUSDT", name: "Ethereum / Tether", assetClass: "Crypto", settlementCurrency: "USDT", quantityUnit: "contracts", contractMultiplier: "0.01", isActive: true },
    ])
    .returning();
  ...
  const tradeSpecs: TradeSpec[] = [
    ...
    { accountId: cryptoAccount.id, instrumentId: btcusdt.id, strategyId: llr.id, setupId: htfLevel.id, direction: "long", timezone: "UTC",
      entries: [{ daysAgo: 26, h: 8, m: 0, price: 68500.0, qty: 10, commission: 6.85 }],
      exits: [{ daysAgo: 26, h: 11, m: 30, price: 70100.0, qty: 10, commission: 7.01 }],
    ...
    { accountId: cryptoAccount.id, instrumentId: btcusdt.id, strategyId: orb.id, setupId: orbShort.id, direction: "short", timezone: "UTC",
      entries: [{ daysAgo: 24, h: 14, m: 30, price: 71200.0, qty: 5, commission: 3.56 }],
      exits: [{ daysAgo: 24, h: 17, m: 0, price: 70400.0, qty: 5, commission: 3.52 }],
    ...
    { accountId: cryptoAccount.id, instrumentId: btcusdt.id, strategyId: tc.id, setupId: emaRibbon.id, direction: "long", timezone: "UTC",
      entries: [{ daysAgo: 20, h: 6, m: 0, price: 69800.0, qty: 8, commission: 5.58 }],
      exits: [{ daysAgo: 20, h: 9, m: 15, price: 69200.0, qty: 8, commission: 5.54 }],
    ...
    { accountId: cryptoAccount.id, instrumentId: ethusdt.id, strategyId: llr.id, setupId: fib618.id, direction: "long", timezone: "UTC",
      entries: [{ daysAgo: 19, h: 10, m: 0, price: 3620.0, qty: 50, commission: 18.10 }],
      exits: [{ daysAgo: 19, h: 14, m: 30, price: 3690.0, qty: 30, commission: 11.07 }, { daysAgo: 18, h: 8, m: 0, price: 3740.0, qty: 20, commission: 7.48 }],
    ...
    { accountId: cryptoAccount.id, instrumentId: btcusdt.id, strategyId: bo.id, setupId: bmsBreak.id, direction: "long", timezone: "UTC",
      entries: [{ daysAgo: 16, h: 15, m: 0, price: 72500.0, qty: 5, commission: 3.63 }],
      exits: [{ daysAgo: 16, h: 18, m: 0, price: 73800.0, qty: 5, commission: 3.69 }],
    ...
    { accountId: cryptoAccount.id, instrumentId: ethusdt.id, strategyId: orb.id, setupId: orbShort.id, direction: "short", timezone: "UTC",
      entries: [{ daysAgo: 13, h: 9, m: 0, price: 3810.0, qty: 40, commission: 15.24 }],
      exits: [{ daysAgo: 13, h: 12, m: 30, price: 3750.0, qty: 40, commission: 15.00 }],
    ...
    { accountId: cryptoAccount.id, instrumentId: btcusdt.id, strategyId: llr.id, setupId: htfLevel.id, direction: "long", timezone: "UTC",
      entries: [{ daysAgo: 9, h: 7, m: 30, price: 71000.0, qty: 7, commission: 4.97 }],
      exits: [{ daysAgo: 9, h: 11, m: 0, price: 70600.0, qty: 7, commission: 4.94 }],
    ...
    { accountId: cryptoAccount.id, instrumentId: ethusdt.id, strategyId: tc.id, setupId: emaRibbon.id, direction: "long", timezone: "UTC",
      entries: [{ daysAgo: 7, h: 12, m: 0, price: 3680.0, qty: 30, commission: 11.04 }],
      exits: [{ daysAgo: 7, h: 16, m: 0, price: 3730.0, qty: 30, commission: 11.19 }],
    ...
    { accountId: cryptoAccount.id, instrumentId: btcusdt.id, strategyId: orb.id, setupId: orbLong.id, direction: "long", timezone: "UTC",
      entries: [{ daysAgo: 3, h: 13, m: 30, price: 73200.0, qty: 5, commission: 3.66 }],
      exits: [{ daysAgo: 3, h: 16, m: 15, price: 74100.0, qty: 5, commission: 3.71 }],
    ...
    { accountId: cryptoAccount.id, instrumentId: ethusdt.id, strategyId: llr.id, setupId: htfLevel.id, direction: "long", timezone: "UTC",
      entries: [{ daysAgo: 0, h: 8, m: 15, price: 3760.0, qty: 20, commission: 7.52 }],
      exits: [],
  ...
  for (const spec of tradeSpecs) {
    ...
    for (const e of spec.entries) {
      await db.insert(executionsTable).values({
        ...
        quantityUnit: spec.accountId === cryptoAccount.id ? "contracts" : "lots",
